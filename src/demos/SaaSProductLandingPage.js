...
import ImageViewer from "components/blogs/ImagesViewer.js";
const Column = tw.div`w-full max-w-md mx-auto md:max-w-none md:mx-0`;
const ImageColumn = tw(Column)`md:w-6/12 flex-shrink-0 relative`;
const MyImage = styled.div((props) => [
  `background-image: url("${props.imageSrc}");`,
  tw` h-144 md:h-144 bg-center bg-cover mx-4 sm:mx-8 md:mx-4 lg:mx-8`,
]);
...
export default () => {
  ...
  return (
    <AnimationRevealPage>
      ...
      <FeatureWithSteps
        subheading={<Subheading>Hiểu thêm về chúng tôi</Subheading>}
        heading={
          <>
            ANH NGỮ TẠI <HighlightedText>GIÁO LÀNG</HighlightedText>
          </>
        }
        textOnLeft={true}
        // imageSrc={""}
      ...
      <ImageViewer
        ...
        imageSrc={"https://yola.vn/wp-content/uploads/2018/03/Final-1.jpg"}
      />
      {/* <SliderCard /> */}
      <Blog
        // subheading="Blog"
      ...
      <FeatureStats />
      {/* <VerticalFeatures /> */}
      {/* <MyImage imageSrc="https://yola.vn/wp-content/uploads/2018/03/Final-1.jpg" /> */}
      {/* <image src={"https://yola.vn/wp-content/uploads/2018/03/Final-1.jpg"} /> */}
      <FAQ
        ...
        faqs={[
          {
            question: "Học phí ở Giáo Làng được tính như thế nào ?",
            answer:
              "Tùy lớp của học sinh mà giá học phí khác nhau, thường trong khoảng từ 900.000VND",
          },
          {
            question:
