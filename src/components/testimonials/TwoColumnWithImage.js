...
const Content = tw.div`max-w-screen-lg mx-auto py-20 lg:py-24`;
const HeadingInfoContainer = tw.div`flex flex-col items-center`;
const HeadingDescription = tw.p`mt-4 font-medium text-gray-600 text-center max-w-sm`;
const SectionHeading = tw.h2`text-2xl sm:text-3xl font-black tracking-wide text-center text-gray-800`;

const TestimonialSliderContainer = tw.div`mt-5`;
...
const QuotesLeft = tw(
  QuotesLeftIcon
)`w-8 h-8 lg:w-10 lg:h-10 text-red-500 absolute top-0 left-0`;
const QuotesRight = tw(
  QuotesRightIcon
)`w-8 h-8 lg:w-10 lg:h-10 text-red-500 absolute bottom-0 right-0`;
    ...
    <Container>
      <Content>
        <HeadingInfoContainer>
          <SectionHeading>CẢM NHẬN TỪ HỌC VIÊN</SectionHeading>
