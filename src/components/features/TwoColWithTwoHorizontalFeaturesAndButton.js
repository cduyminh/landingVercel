...
const Heading = tw(
  SectionHeading
)`mt-4 font-black  text-gray-800 text-left text-2xl sm:text-2xl lg:text-3xl text-center md:text-left leading-tight`;
const Description = tw.p`mt-8 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-gray-800`;
...
`;
const FeatureHeading = tw.div`ml-3 font-bold text-lg`;

const FeatureDescription = tw.div`mt-4 text-center md:text-left text-gray-800 leading-relaxed`;
...
export default ({
  ...
  heading = (
    <>
      Designed & Developed by <span tw="text-gray-800">Professionals.</span>
    </>
  ),
  ...
  const defaultFeatures = [
    {
      ...
      description:
        "Các khóa học IELTS diễn ra cả trong tuần lẫn cuối tuần, đảm bảo thời gian cho cả những người đã đi làm được học tốt nhất.",
    ...
    },
    {
      ...
      title: "GIÁ TRỊ CAO",
      description:
        "Các khóa học luôn tập trung xung quanh giá trị của học viên, từ đó cho học sinh một lộ trình học phù hợp với bản thân nhất.",
