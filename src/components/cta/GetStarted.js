...
const PrimaryBackgroundContainer = tw.div`py-20 lg:py-24 bg-red-500 rounded-lg relative`;
...
const SecondaryLink = tw(
  Link
)`text-gray-100 border-gray-500 hover:bg-gray-100 hover:text-red-500 hover:border-red-500`;
